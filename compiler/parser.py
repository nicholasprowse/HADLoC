...
class Parser:
    ...
    # TODO add inheritance and generics to classes
    ...
    def constructor_invocation(self):
        ...
        | **ConstructorInvocation**     ::=  ('this' | 'super') '(' (Expression (',' Expression)*)? ')' ';'
        ...
        self.parse(self.expression, node, 'Arguments')
        while self.match(','):
            if not self.parse(self.expression, node, 'Arguments'):
                raise CompilerException(CompilerException.SYNTAX,
